...
export const SILHOUETTES: Record<string, string> = {
  ...
  // Mzansi Moments extras
  karoo:
    "M0 40 L0 30 L26 30 L30 22 L32 21 L44 21 L46 22 L50 30 L100 30 L100 40 Z",
  namaqualand:
    "M0 40 L0 28 Q18 22 38 26 Q58 30 76 24 Q90 20 100 24 L100 40 Z",
  soweto:
    "M0 40 L0 32 L14 32 L16 14 Q21 10 26 14 L28 32 L38 32 L40 18 Q45 14 50 18 L52 32 L100 32 L100 40 Z",
};
